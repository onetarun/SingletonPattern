...
using SingletonPattern.APP.Models;
    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddHttpClient("MyAPIClient", (serviceProvider, client) =>
            {
                ...
                client.DefaultRequestHeaders.Add("X-Client-Id", appSettings.ClientId);
                client.DefaultRequestHeaders.Add("X-Client-Secret", appSettings.ClientSecret);
            });
